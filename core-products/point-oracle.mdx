...
The **Points Oracle** is Checkpoint's verification layer. It fetches points data from off-chain sources and signs it with cryptographic signatures, making the data verifiable on-chain.
...
Broadly, the Points Oracle caters to users by allocating the [Checkpoint NFT](/core-products/checkpoint-point-nfts) to elligible wallets and to developers who want to integrate their points system to the [Checkpoint Ecosystem](/architecture/oracle-system).
