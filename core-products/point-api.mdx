---
title: "Points API"
description: "Programmatic access to points data for developers and builders"
---
<img 
  className="block dark:hidden rounded-lg" 
  src="/images/API_Title_Light.png" 
  alt="Checkpoint API title image, light theme"
  draggable="false"
...
<img 
  ...
  alt="Checkpoint API title image, dark theme"
  draggable="false"
  style={{ pointerEvents: 'none' }}
/>
...
<img 
  ...
  alt="Checkpoint API dashboard screenshot, dark theme"
/>

<img 
  className="hidden dark:block rounded-lg" 
  src="/images/API_Screen_Light.png" 
  alt="Checkpoint API dashboard screenshot, light theme"
/>
