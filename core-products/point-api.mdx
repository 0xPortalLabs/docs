...
The Points API provides developers with programmatic access to Checkpoint's points data across 30+ DeFi protocols. Query points balances, retrieve historical data, and integrate points tracking directly into your applications with simple REST endpoints.
...
<CardGroup cols={2}>
  <Card title="Multi-Protocol Support" icon="layer-group" color="#32cd32">
    Query points data across 30+ DeFi protocols through a single unified interface
  </Card>
  <Card title="Real-time Data" icon="clock" color="#32cd32">
    Access up-to-date points balances and rankings for any address
  </Card>
  <Card title="Normalized Data Format" icon="code" color="#32cd32">
    All points data is normalized into a consistent JSON format across all protocols
  </Card>
  <Card title="Flexible Queries" icon="sliders" color="#32cd32">
...
- [Full documentation →](/api-reference/points/get-points-data-for-a-specific-address)
...
- [Full documentation →](/api-reference/points/list-all-available-adapters)
...
<Steps>
  <Step title="Generate API Key">
    Sign in to the <a href="https://points.0xportal.io/apikeys" target="_blank">Portal Dashboard</a> and create a new API key
  </Step>
...
If you need higher rate limits for your use case, please reach out to us.

## Use Cases

<CardGroup cols={2}>
  <Card title="Points Dashboard" icon="chart-line" color="#32cd32">
    Build web applications that display points balances and rankings across protocols
  </Card>
  <Card title="Trading Integrations" icon="arrows-repeat" color="#32cd32">
    Integrate points data into trading platforms and portfolio trackers
  </Card>
  <Card title="Analytics Platforms" icon="magnifying-glass" color="#32cd32">
    Analyze points distribution, trends, and market data across protocols
  </Card>
  <Card title="Automated Tools" icon="robot" color="#32cd32">
...
<Steps>
  <Step title="Get API Key">
    Sign up and generate an API key from the <a href="https://points.0xportal.io/apikeys" target="_blank">Portal Dashboard</a>
  </Step>
