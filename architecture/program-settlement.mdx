...
description: "Post-TGE token distribution and market closure"
---
...
store this on-chain on `Settlement.sol`. Then anyone can permissionlessly send the message to the
